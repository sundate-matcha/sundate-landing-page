...
const Icons = {
  ...
  form: (props: IconProps) => <ClipboardTypeIcon {...props} />,
...
const DATA = {
  ...
  contact: {
    social: {
      Facebook: {
        name: 'Facebook',
        url: 'https://www.facebook.com/profile.php?id=61566374901519',
        icon: Icons.facebook,
        color: 'text-[#17A9FD]',
      },
      Threads: {
...
function DockNav() {
  return (
    <>
      <div className="fixed z-[999] bottom-2 left-1/2 -translate-x-1/2">
        <TooltipProvider>
          <Dock
            direction="middle"
                ...
                <Tooltip delayDuration={150}>
                  <TooltipTrigger asChild>
                    <a
                      ...
                      className={cn(
                        buttonVariants({ variant: 'ghost', size: 'icon' }),
                        `size-12 rounded-full ${social.color}`,
                      )}
                    >
              ...
              <Tooltip delayDuration={150}>
                <TooltipTrigger asChild>
                  <a
                    ...
                    className={cn(
                      buttonVariants({ variant: 'ghost', size: 'icon' }),
                      // NOTE: This is the line that make of style
                      'size-12 rounded-full',
                    )}
                  >
