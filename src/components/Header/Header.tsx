...
function Header() {
  ...
  return (
    <header
      className={`px-4 md:px-20 py-6 flex items-center justify-between w-full h-[10vh] z-50 text-foreground fixed top-0 left-0 transition-colors duration-500 bg-background
      `}
    >
      <Link
        to={'/'}
